...
namespace qldoansvhutech.Models
{
    ...
    partial void OnTuanChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sinhvien_Congviectuan", Storage="_Sinhvien", ThisKey="Id_sv", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Sinhvien.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Congviectuans.Remove(this);
					}
					this._Sinhvien.Entity = value;
					if ((value != null))
					{
						value.Congviectuans.Add(this);
    ...
    partial void OnId_cvChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Gvhd_Doan", Storage="_Gvhd", ThisKey="Id_gv", OtherKey="Id", IsForeignKey=true)]
		public Gvhd Gvhd
		{
			get
			{
    ...
    partial void OnNgaySinhChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Gvhd_Doan", Storage="_Doans", ThisKey="Id", OtherKey="Id_gv")]
		public EntitySet<Doan> Doans
		{
			get
			{
	...
	public partial class Sinhvien : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Congviectuan> _Congviectuans;
    ...
    partial void OnNgaySinhChanged();
		...
		public Sinhvien()
		{
			this._Congviectuans = new EntitySet<Congviectuan>(new Action<Congviectuan>(this.attach_Congviectuans), new Action<Congviectuan>(this.detach_Congviectuans));
			this._Doans = new EntitySet<Doan>(new Action<Doan>(this.attach_Doans), new Action<Doan>(this.detach_Doans));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Sinhvien_Congviectuan", Storage="_Congviectuans", ThisKey="Id", OtherKey="Id_sv")]
		public EntitySet<Congviectuan> Congviectuans
		{
			get
			{
				return this._Congviectuans;
			}
			set
			{
				this._Congviectuans.Assign(value);
			}
		}
		...
		private void attach_Congviectuans(Congviectuan entity)
		{
			this.SendPropertyChanging();
			entity.Sinhvien = this;
		}
		
		private void detach_Congviectuans(Congviectuan entity)
		{
			this.SendPropertyChanging();
